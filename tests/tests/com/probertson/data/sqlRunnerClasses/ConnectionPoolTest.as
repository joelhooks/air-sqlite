package tests.com.probertson.data.sqlRunnerClasses
{
    ...
    public class ConnectionPoolTest extends EventDispatcher
	{
		...
		public function testAddBlockingBatchThenPendingStatement():void
		{
			...
			var pendingBatch:IPendingBatch = new PendingBatch(stmts, params, testAddBlockingBatchThenPendingStatement_batchResult, testAddBlockingBatchThenPendingStatement_batchError, null);
			_connectionPool.addBlockingBatch(pendingBatch);
			var pendingStatement:IPendingStatement = new PendingStatement(new StatementCache(LOAD_ROWS_LIMIT_SQL), null, testAddBlockingBatchThenPendingStatement_executeResult, null, testAddBlockingBatchThenPendingStatement_executeError);
